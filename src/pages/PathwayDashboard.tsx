  ...
  return (
    <div>
      ...
      <div className="card" style={{ marginBottom: 'var(--sp-md)', background: 'linear-gradient(135deg, rgba(154,184,46,0.06) 0%, var(--surface) 60%)' }}>
        ...
        <p style={{ fontSize: 'var(--text-sm)', color: 'var(--text-default)', lineHeight: 1.65, marginBottom: analysis.timelineEst ? 'var(--sp-sm)' : 0 }}>{analysis.summary}</p>
        {analysis.timelineEst && (
          <div style={{ borderTop: '1px solid var(--border)', paddingTop: 'var(--sp-sm)', marginTop: 'var(--sp-sm)', fontSize: 'var(--text-xs)', color: 'var(--text-muted)', lineHeight: 1.55 }}>
            <strong style={{ color: 'var(--text-default)' }}>Timeline:</strong> {analysis.timelineEst}
          </div>
        )}
      </div>
